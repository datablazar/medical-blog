...
references:
  ...
  - text: "Murad MH, Asi N, Alsawas M, Alahdab F. New evidence pyramid. Evid Based Med. 2016;21(4):125–127."
  ...
  - text: "Smith GCS, Pell JP. Parachute use to prevent death and major trauma related to gravitational challenge: systematic review of randomised controlled trials. BMJ. 2003;327(7429):1459–1461."
    url: https://doi.org/10.1136/bmj.327.7429.1459
  - text: "Howick J, Glasziou P, Aronson JK. Evidence-based mechanistic reasoning. J R Soc Med. 2010;103(11):433–441."
    url: https://doi.org/10.1258/jrsm.2010.100146
  - text: "Altman DG, Bland JM. Absence of evidence is not evidence of absence. BMJ. 1995;311(7003):485."
    url: https://doi.org/10.1136/bmj.311.7003.485
  - text: "White PD, Goldsmith KA, Johnson AL, et al. Comparison of adaptive pacing therapy, cognitive behaviour therapy, graded exercise therapy, and specialist medical care for chronic fatigue syndrome (PACE): a randomised trial. Lancet. 2011;377(9768):823–836."
    url: https://doi.org/10.1016/S0140-6736(11)60096-2
  - text: "Wood L, Egger M, Gluud LL, et al. Empirical evidence of bias in treatment effect estimates in controlled trials with different interventions and outcomes: meta-epidemiological study. BMJ. 2008;336(7644):601–605."
    url: https://doi.org/10.1136/bmj.39465.451748.AD
  - text: "Wilshire CE, Kindlon T, Courtney R, et al. Rethinking the treatment of chronic fatigue syndrome—a reanalysis and evaluation of findings from a recent major trial of graded exercise and CBT. BMC Psychol. 2018;6:6."
    url: https://doi.org/10.1186/s40359-018-0218-3
  - text: "Institute of Medicine. Beyond Myalgic Encephalomyelitis/Chronic Fatigue Syndrome: Redefining an Illness. Washington, DC: The National Academies Press; 2015."
    url: https://doi.org/10.17226/19012
  - text: "National Institute for Health and Care Excellence. Myalgic encephalomyelitis (or encephalopathy)/chronic fatigue syndrome: diagnosis and management (NG206). London: NICE; 2021."
    url: https://www.nice.org.uk/guidance/ng206
  - text: "Mirin AA, Dimmock ME, Jason LA. Research update: the relation between ME/CFS disease burden and research funding in the USA. Work. 2020;66(2):277–282."
    url: https://doi.org/10.3233/WOR-203173
  - text: "Walitt B, Singh K, LaMunion SR, et al. Deep phenotyping of post-infectious myalgic encephalomyelitis/chronic fatigue syndrome. Nat Commun. 2024;15:907."
    url: https://doi.org/10.1038/s41467-024-45107-3
  - text: "Davenport TE, Scheibenbogen C, Zinn MA, et al. Altered effort and deconditioning are not valid explanations of myalgic encephalomyelitis/chronic fatigue syndrome. Nat Commun. 2025;16:9176."
    url: https://doi.org/10.1038/s41467-025-64538-0
  - text: "Davis HE, McCorkell L, Vogel JM, Topol EJ. Long COVID: major findings, mechanisms and recommendations. Nat Rev Microbiol. 2023;21(3):133–146."
    url: https://doi.org/10.1038/s41579-022-00846-2
  - text: "Geng LN, Bonilla H, Hedlin H, et al. Nirmatrelvir-ritonavir and symptoms in adults with postacute sequelae of SARS-CoV-2 infection: the STOP-PASC randomized clinical trial. JAMA Intern Med. 2024;184(9):1024–1034."
    url: https://doi.org/10.1001/jamainternmed.2024.2007
  - text: "Malfait F, Francomano C, Byers P, et al. The 2017 international classification of the Ehlers–Danlos syndromes. Am J Med Genet C Semin Med Genet. 2017;175(1):8–26."
    url: https://doi.org/10.1002/ajmg.c.31552
  - text: "Reychler G, De Backer MM, Piraux E, Poncin W, Caty G. Physical therapy treatment of hypermobile Ehlers–Danlos syndrome: a systematic review. Am J Med Genet A. 2021;185(10):2986–2994."
...
1. **Systematic reviews and meta-analyses** gather and combine every good-quality study on a question. Done well, they are the strongest evidence there is.
2. **Randomised controlled trials (RCTs)** assign people to a treatment or a comparison by chance, so the groups differ only in the treatment. A well-run, blinded RCT is often called the “gold standard” for testing whether a treatment works.
3. **Observational studies** (cohort and case–control studies) follow people who were not randomly assigned. They can show that two things are linked, but not always which causes which.
4. **Case series and case reports** describe what happened to a small number of patients. They are often the first sign that something new is going on.
5. **Mechanistic and laboratory research** studies how an illness works: in cells, blood, tissue, animals or brain scans. It can explain why a treatment might work, but not whether it does.
6. **Expert opinion and theory** reason from what is already known. They are essential for generating ideas, and the weakest way to prove them.
...
1. **What kind of study is it?** Where does it sit on the ladder?
2. **Were the right people studied?** Does the study's definition of the illness match yours?
3. **Could participants tell which treatment they had?** And were the results self-reported?
